        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // UserManager.AddClaim(user.Id, new Claim(ClaimTypes.Email, usr.Email));

                    try
                    {
                        CustomerManager _customerManager = new CustomerManager();
                        if (_customerManager.CreateCustomerAccount(model.FirstName, model.LastName, model.PhoneNum, model.Zip, model.Email))
                        {
